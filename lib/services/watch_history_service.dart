...
class WatchHistoryService {
  ...
  Future<List<WatchHistoryItem>> getWatchHistory() async {
    try {
        ...
        return data.map((item) {
          ...
          final movie = Movie(
            ...
            releaseDate: movieData['releaseDate'] != null
                ? DateTime.parse(movieData['releaseDate'])
                    .toString()
                    .substring(0, 10)
                : '',
      ...
      throw Exception(
          'Failed to load watch history: ${e.toString().replaceAll('Exception: ', '')}');
    }
  }
  ...
  Future<WatchHistoryItem> updateWatchProgress({
    ...
    try {
      ...
      throw Exception(
          'Failed to update watch progress: ${e.toString().replaceAll('Exception: ', '')}');
    }
  }
}
